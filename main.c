...
void definer(void){
    rKp = 0;          // Roll proportional constant
    rKi = 0;           // Roll integral constant
    rKd = 0;         // Roll derivative constant
    pKp = 0;          // Pitch proportional constant
    pKi = 0;            // Pitch integral constant
    pKd = 0;            // Pitch derivative constant
    hKp = 0;             // Height proportional constant
    hKi = 0;              // Height integral constant
    hKd = 0;               // Height derivative constant
